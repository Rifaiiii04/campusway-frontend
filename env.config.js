...
const config = {
  ...
  production: {
    API_BASE_URL: 'http://103.23.198.101/api/school',
    STUDENT_API_BASE_URL: 'http://103.23.198.101/api/web',
    SUPERADMIN_API_URL: 'http://103.23.198.101/api',
    BACKEND_URL: 'http://103.23.198.101',
