...
const API_CONFIG = {
  // Base URLs
  BASE_URL: process.env.NEXT_PUBLIC_BACKEND_URL || 'http://103.23.198.101:8080',
  API_BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL || 'http://103.23.198.101:8080/api/school',
  STUDENT_API_BASE_URL: process.env.NEXT_PUBLIC_STUDENT_API_BASE_URL || 'http://103.23.198.101:8080/api/web',
  SUPERADMIN_API_URL: process.env.NEXT_PUBLIC_SUPERADMIN_API_URL || 'http://103.23.198.101:8080/api',
