...
export default function AddClassModal({ isOpen, onClose, onAddClass, darkMode }: AddClassModalProps) {
      ...
      <div className={`${darkMode ? 'bg-gradient-to-br from-gray-800/95 via-gray-900/95 to-gray-800/95' : 'bg-gradient-to-br from-white/95 via-gray-50/95 to-white/95'} backdrop-blur-xl rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col border ${darkMode ? 'border-gray-600/50' : 'border-gray-200/50'}`}>
        ...
        <div className={`px-6 py-5 border-b ${darkMode ? 'border-gray-600/50 bg-gradient-to-r from-gray-700/90 via-gray-800/90 to-gray-700/90' : 'border-gray-200/50 bg-gradient-to-r from-green-50/90 via-emerald-50/90 to-teal-50/90'} backdrop-blur-sm rounded-t-2xl flex-shrink-0`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Tambah Kelas Baru</h2>
                <p className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Buat kelas baru untuk mengelompokkan siswa</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto">
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
              <div>
                ...
                <input
                  ...
                  placeholder="Masukkan nama kelas (contoh: X IPA 1, X IPS 2)"
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200 ${
                    darkMode ? 'bg-gray-700 border-gray-600 text-gray-100 placeholder-gray-400 hover:border-gray-500' : 'bg-white border-gray-300 text-gray-900 placeholder-gray-500 hover:border-gray-400'
                  }`}
                />
              </div>
              ...
              <div>
                ...
                >
                  <option value="" className={`${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Pilih tingkat</option>
                  <option value="X" className={`${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>Kelas X</option>
                  <option value="XI" className={`${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>Kelas XI</option>
                  <option value="XII" className={`${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>Kelas XII</option>
                </select>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Masukkan jumlah maksimal siswa (contoh: 32, 36)"
                  min="1"
                  max="50"
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200 ${
                    darkMode ? 'bg-gray-700 border-gray-600 text-gray-100 placeholder-gray-400 hover:border-gray-500' : 'bg-white border-gray-300 text-gray-900 placeholder-gray-500 hover:border-gray-400'
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Masukkan nama lengkap wali kelas (contoh: Ahmad Suryadi, S.Pd)"
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200 ${
                    darkMode ? 'bg-gray-700 border-gray-600 text-gray-100 placeholder-gray-400 hover:border-gray-500' : 'bg-white border-gray-300 text-gray-900 placeholder-gray-500 hover:border-gray-400'
                  }`}
                />
            ...
            <div className={`${darkMode ? 'bg-gradient-to-r from-gray-700/80 to-gray-800/80' : 'bg-gradient-to-r from-green-50/80 to-emerald-50/80'} backdrop-blur-sm rounded-2xl p-5 border ${darkMode ? 'border-gray-600/50' : 'border-green-200/50'} mb-6`}>
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <div className={`space-y-2.5 ${darkMode ? 'text-green-200' : 'text-green-800'}`}>
                    <div className="flex items-start">
                      <span className="w-2 h-2 bg-green-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                      <span className="text-sm">Kelas akan otomatis tersedia untuk pendaftaran siswa</span>
                    </div>
                    <div className="flex items-start">
                      <span className="w-2 h-2 bg-green-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    ...
                    <div className="flex items-start">
                      <span className="w-2 h-2 bg-green-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                      <span className="text-sm">Kapasitas kelas dapat diubah nanti di pengaturan</span>
                    </div>
                    <div className="flex items-start">
                      <span className="w-2 h-2 bg-green-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                      <span className="text-sm">Wali kelas dapat ditambahkan atau diubah setelah kelas dibuat</span>
                    </div>
                  </div>
                </div>
              </div>
