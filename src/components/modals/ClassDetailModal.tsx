...
export default function ClassDetailModal({ isOpen, onClose, classData, darkMode }: ClassDetailModalProps) {
        ...
        <div className={`px-6 py-5 border-b ${darkMode ? 'border-gray-600/50 bg-gradient-to-r from-gray-700/90 via-gray-800/90 to-gray-700/90' : 'border-gray-200/50 bg-gradient-to-r from-blue-50/90 via-indigo-50/90 to-purple-50/90'} backdrop-blur-sm rounded-t-2xl flex-shrink-0`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Detail Kelas</h2>
                <p className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Informasi lengkap kelas</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-6">
            ...
            <div className="flex items-center mb-6">
              ...
              <div className="ml-6">
                <h3 className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>{classData.class_name}</h3>
                <p className={`text-lg ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Kelas {classData.grade}</p>
                <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>ID: {classData.class_id}</p>
              </div>
            </div>

            {/* Statistics Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-blue-50'} rounded-xl p-4`}>
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>{classData.total_students}</p>
                  </div>
                </div>
              </div>

              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-green-50'} rounded-xl p-4`}>
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>{classData.completed_tests}</p>
                  </div>
                </div>
              </div>

              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-yellow-50'} rounded-xl p-4`}>
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>{classData.completion_rate}%</p>
                  </div>
                </div>
              </div>

              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-purple-50'} rounded-xl p-4`}>
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className={`text-sm font-medium ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Rata-rata</p>
                    <p className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>{classData.average_score.toFixed(1)}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-gray-50'} rounded-xl p-6`}>
                ...
                <div className="space-y-3">
                  <div>
                    <p className={`text-sm font-medium ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Nama Kelas</p>
                    <p className={`${darkMode ? 'text-white' : 'text-gray-900'}`}>{classData.class_name}</p>
                  </div>
                  <div>
                    <p className={`text-sm font-medium ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Tingkat</p>
                    <p className={`${darkMode ? 'text-white' : 'text-gray-900'}`}>Kelas {classData.grade}</p>
                  </div>
                  <div>
                    <p className={`text-sm font-medium ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>ID Kelas</p>
                    <p className={`${darkMode ? 'text-white' : 'text-gray-900'}`}>{classData.class_id}</p>
                  </div>
                </div>
              </div>
              ...
              <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-gray-50'} rounded-xl p-6`}>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className={`${darkMode ? 'text-white' : 'text-gray-900'}`}>{classData.total_tests}</p>
                  </div>
                  <div>
                    <p className={`text-sm font-medium ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Tes Selesai</p>
                    <p className={`${darkMode ? 'text-white' : 'text-gray-900'}`}>{classData.completed_tests}</p>
                  </div>
                  <div>
                    <p className={`text-sm font-medium ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Tingkat Penyelesaian</p>
                    <div className="flex items-center">
                      <div className={`w-20 rounded-full h-2 mr-3 ${darkMode ? 'bg-gray-600' : 'bg-gray-200'}`}>
                        <div 
                          className="bg-green-600 h-2 rounded-full" 
                          style={{ width: `${classData.completion_rate}%` }}
                        ></div>
                      </div>
                      <span className={`text-sm ${darkMode ? 'text-gray-300' : 'text-gray-900'}`}>{classData.completion_rate}%</span>
                    </div>
                  </div>
                  <div>
            ...
            <div className={`${darkMode ? 'bg-gray-700/50' : 'bg-gray-50'} rounded-xl p-6 mt-6`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Total Siswa</p>
                </div>
                <div className="text-center">
                  <p className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>
                    {classData.completed_tests}
                  </p>
                  <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Tes Selesai</p>
                </div>
                <div className="text-center">
                  <p className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>
                    {classData.average_score.toFixed(1)}
                  </p>
                  <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Rata-rata Nilai</p>
                </div>
              </div>
            </div>
          </div>
